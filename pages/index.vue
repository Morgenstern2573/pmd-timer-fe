    ...
    <div>
      <header>
        ...
        >
          ...
          >
            <svg
              class="w-12 h-12 text-white p-2 bg-red-500 rounded-full"
              viewBox="0 0 24 24"
            >
              <path
                fill="currentColor"
            ...
            <span class="ml-3 text-xl uppercase">Tomato timer</span>
          </a>
          <nav
            class="md:ml-auto flex flex-wrap items-center text-base justify-center"
          >
            <a
              class="mr-5 cursor-pointer text-red-500"
              title="Settings"
          ...
          <button
            class="inline-flex items-center text-red-900 bg-white border border-red-900 py-1 px-3 focus:outline-none hover:bg-red-900 hover:text-white rounded text-base mt-4 md:mt-0"
            @click="logOut"
          >
            Log Out
          </button>
